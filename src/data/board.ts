...
const positions: Record<string, Position> = {
    ...
    "PR Extern": {
        name: "PR Extern",
        description: "Manages external public relations.",
    },
    "PR Intern": {
        name: "PR Intern",
        description: "Handles internal public relations.",
    },
    "Electronics (LV)": {
        name: "Electronics (LV)",
        description: "Responsible for low-voltage electronics.",
    },
    "Electronics (HV)": {
        name: "Electronics (HV)",
        description: "Responsible for high-voltage electronics.",
    },
    "AI": {
        name: "AI",
        description: "Focuses on artificial intelligence applications.",
    },
    ...
    "Treasurer": {
        name: "Treasurer",
        description: "Manages the financial affairs of the organization.",
    },
    "Web": {
        name: "Web",
        description: "Responsible for the website and online presence.",
    },
    "PR": {
        name: "PR",
        description: "Handles public relations and communication.",
    },
    "Corporate": {
        name: "Corporate",
        description: "Manages corporate partnerships and sponsorships.",
    },

    // Teams
    "Team Autonomous": {
        name: "Team Autonomous",
        description: "Focuses on autonomous systems and robotics.",
    },
    "Team Construction": {
        name: "Team Construction",
        description:
            "Responsible for the construction and design of physical structures.",
    },
    "Team Electronics": {
        name: "Team Electronics",
        description: "Handles electronic components and systems.",
    },
    "Team Design": {
        name: "Team Design",
        description: "Focuses on design aspects of projects.",
    },
    "Team Energy": {
        name: "Team Energy",
        description: "Works on energy systems and sustainability.",
    },
    "Team Naval": {
        name: "Team Naval",
        description: "Focuses on naval engineering and maritime projects.",
    },

    // Volunteers
    "Volunteer Autonomous": {
        name: "Volunteer Autonomous",
        description: "Assists the Autonomous team with various tasks.",
    },
    "Volunteer Construction": {
        name: "Volunteer Construction",
        description: "Supports the Construction team in building projects.",
    },
    "Volunteer Electronics": {
        name: "Volunteer Electronics",
        description:
            "Helps the Electronics team with circuit design and assembly.",
    },
    "Volunteer Design": {
        name: "Volunteer Design",
        description: "Aids the Design team in creating visual materials.",
    },
    "Volunteer Energy": {
        name: "Volunteer Energy",
        description: "Assists the Energy team with energy-related tasks.",
    },
};
